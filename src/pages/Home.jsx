...
export default function Home() {
  ...
  <div className="relative mx-auto flex w-full max-w-md items-center justify-center py-8">
    <div
      className="absolute h-72 w-72 rounded-full bg-gold/10 blur-3xl"
      aria-hidden="true"
    />

    <div className="relative flex h-64 w-64 items-center justify-center rounded-full border border-gold/50 bg-panel/80 p-10 shadow-[0_0_70px_rgba(201,162,74,0.16)]">
      <div className="absolute inset-3 rounded-full border border-gold-dim/50" />
      <img
        src={UPPER_IMAGE}
