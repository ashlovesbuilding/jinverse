...
export default function ArticleEditor() {
  ...
  async function uploadImage(event) {
    ...
    setStatus('Image uploaded. Save the article to publish it.')
    setUploading(false)
  }
  ...
  async function saveDraft(event) {
    ...
    setStatus(error ? `Shared save failed: ${error.message}` : 'Article published to the shared JINVERSE library.')
  }
